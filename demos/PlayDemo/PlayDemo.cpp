...
void InitResource()
{
	...
	case UILIB_FILE:
	{
		strResourcePath += _T("skin\\PlayDemo\\");
	...
	case UILIB_ZIP:
	{
		...
		CPaintManagerUI::SetResourcePath(strResourcePath.GetData());
		// 加密
		CPaintManagerUI::SetResourceZip(_T("playdemo_pwd.zip"), true, _T("playdemo_duilib_ffmpeg"));
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
	...
	pMainWnd->Create(NULL, _T("PlayDemo"), UI_WNDSTYLE_FRAME, 0L, 0, 0, 800, 572);
